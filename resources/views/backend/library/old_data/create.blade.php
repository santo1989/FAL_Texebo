                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="Stage" id="Stage" class="form-control">
                            ...
                            <option value="CuttingData" {{ old('Stage') == 'CuttingData' ? 'selected' : '' }}>Cutting
                                Data</option>
                            <option value="SublimationPrintSend"
                                {{ old('Stage') == 'SublimationPrintSend' ? 'selected' : '' }}>Sublimation Print Send
                            </option>
                            <option value="SublimationPrintReceive"
                                {{ old('Stage') == 'SublimationPrintReceive' ? 'selected' : '' }}>Sublimation Print
                                Receive</option>
                            <option value="PrintSendData" {{ old('Stage') == 'PrintSendData' ? 'selected' : '' }}>Print
                                Send Data</option>
                            <option value="PrintReceiveData"
                                {{ old('Stage') == 'PrintReceiveData' ? 'selected' : '' }}>Print Receive Data</option>
                            ...
                            {{-- <option value="ShipmentData" {{ old('Stage') == 'ShipmentData' ? 'selected' : '' }}>
                                Shipment Data</option> --}}
                        </select>
                    </div>
                </div>
                <div class="col-md-3">
                                    ...
                                    @foreach ($allSizes as $size)
                                        {
                                            ...
                                            const availableQty = combination.available_quantities[
                                                sizeName] || 0;
                                            const savedQty = (savedInputs[key] && savedInputs[key].qty &&
                                                savedInputs[key].qty[sizeId]) || 0;
