            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <dl class="row">
                        ...
                        <dd class="col-sm-9">{{ $finishPackingDatum->po_number }}</dd>
                        ...
                        <dt class="col-sm-3">Total Packing Quantity</dt>
                        <dd class="col-sm-9">{{ $finishPackingDatum->total_packing_quantity }}</dd>

                        <dt class="col-sm-3">Total Waste Quantity</dt>
                        <dd class="col-sm-9">{{ $finishPackingDatum->total_packing_waste_quantity ?? 0 }}</dd>
                            ...
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    @foreach($allSizes as $size)
                                        @if(isset($finishPackingDatum->packing_quantities[$size->id]) || isset($finishPackingDatum->packing_waste_quantities[$size->id]))
                                            <tr>
                                                <td>{{ $size->name }}</td>
                                                <td>{{ $finishPackingDatum->packing_quantities[$size->id] ?? 0 }}</td>
                                                <td>{{ $finishPackingDatum->packing_waste_quantities[$size->id] ?? 0 }}</td>
                                            </tr>
                                        @endif
                                    @endforeach
                                </tbody>
