<!-- Blade View: resources/views/backend/library/shipment_data/reports/waste.blade.php -->
<x-backend.layouts.master>
    ...
    <x-slot name='breadCrumb'>
        <x-backend.layouts.elements.breadcrumb>
            <x-slot name="pageHeader"> Waste Quantity Report </x-slot>
            <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ route('shipment_data.index') }}">Shipment</a></li>
            <li class="breadcrumb-item active">Waste Report</li>
        </x-backend.layouts.elements.breadcrumb>
    </x-slot>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Production Stage Waste Report</h3>
                ...
                <div class="card-body" style="overflow-x: auto;">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <form method="GET" action="{{ route('shipment_data.report.waste') }}">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label>Style</label>
                    ...
                    @else
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-sm" id="waste-report-table">
                                <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr class="font-weight-bold">
                                        ...
                                        <td class="text-right">{{ $allRows->sum('total_waste') }}</td>
                                    </tr>
                                    @foreach ($groupedData as $groupKey => $group)
                                        @foreach ($group['rows'] as $index => $row)
                                            <tr>
                                                ...
                                                <td class="text-right">{{ $row['total_waste'] }}</td>
                                            </tr>
                                        @endforeach
                                    @endforeach 
    ...
    <script>
        document.getElementById('export-excel').addEventListener('click', function() {
            ...
            const originalTable = document.getElementById('waste-report-table');
            ...
            const fileName = `waste_report_${dateStr}.xlsx`;
